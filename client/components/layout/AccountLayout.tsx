  ...
  return (
    <NavLink
      ...
      className={({ isActive }) => cn(
        "flex items-center gap-3 px-[14px] py-[10px] rounded-[6px] transition-all group text-[13.5px] select-none",
        isActive
          ? "bg-white text-carry-light border-l-[3px] border-carry-light shadow-[0_1px_6px_rgba(4,55,75,0.08)]"
    ...
    >
      ...
      {badge !== undefined && (
        <span className={cn(
          "text-[9px] font-bold px-1.5 py-0.5 rounded-full min-w-[18px] text-center uppercase tracking-tighter",
        ...
        <div className="page-banner bg-carry-dark border-b border-carry-light/20 px-6 md:px-[56px] py-7 md:py-8">
          <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex flex-col gap-1 w-full md:w-auto">
              <span className="text-[10px] font-bold uppercase tracking-widest text-white/50">Peer-to-Peer Delivery</span>
              <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight">
                My <span className="text-carry-light">CarryLink</span> Account
              </h1>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <nav className="flex flex-col gap-0.5">
                  <SidebarItem to="/account/dashboard" icon={LayoutDashboard} label="Overview" />
                  ...
                  />
                  <SidebarItem to="/account/reviews" icon={Star} label="Reputation Score" />
